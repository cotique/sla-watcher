...
public sealed class WorkingHours
{
    ...
    /// or an overlap whose end precedes its start, and neither contributes. An early return
    /// stood here until a mutation showed no test could tell whether it was present.
    /// </para>
    /// </summary>
